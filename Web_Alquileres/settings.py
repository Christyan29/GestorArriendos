"""
Django settings for Web_Alquileres project.
...
ADMIN_EMAIL = config('ADMIN_EMAIL', default='yadiralucio30@gmail.com')
...
SECRET_KEY = 'django-insecure-v%xl9!=x0c^m03er_nke0usi*xd4_qt6wv%k()&6g@*o!n*%h-'
...
ROOT_URLCONF = 'Web_Alquileres.urls'
...
WSGI_APPLICATION = 'Web_Alquileres.wsgi.application'
